...
const login = require('./gojo/hzi/index.js');
...
const { Sequelize, sequelize } = require("./gojo/database/index.js");
...
const langFile = (readFileSync(`${__dirname}/core/languages/${global.config.language || "en"}.lang`, { encoding: 'utf-8' })).split(/\r?\n|\r/);
...
(async() => {
    try {
        ...
        authentication.sequelize = sequelize;
        const models = require('./gojo/database/model.js')(authentication);
