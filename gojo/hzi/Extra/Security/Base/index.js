...
if (!fs.existsSync(process.cwd() + '/core/database') || !fs.existsSync(process.cwd() + '/core/database/RandPass.json')) {
  ...
  if (!fs.existsSync(process.cwd() + '/core/database')) {
    fs.mkdirSync(process.cwd() + '/core/database');
  }
  fs.writeFileSync(process.cwd() + '/core/database/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/core/database/RandPass.json'));
}
